...
# COD in gO2/m3
COD_obj = 100  # please complete with actual value
```
...
"""
main.results(TSS_in,BOD5_in,TKN_in,COD_in,TSS_obj,BOD5_obj,TKN_obj,COD_obj,Q,climate)
```
